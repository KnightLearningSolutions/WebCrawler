...
import com.ncu.validators.FileValidator;
...
{ 
  ...
  public void inputUrl()
  {
    ...
    // Calling UrlValidator classe to Check all validations of url.
  ...
  public void searchValue(String urlName)
  {
    ...
    // Taking Url as a input from user.
  	...
  	String searchValue= scan.nextLine();
		...
		// Calling SearchInputValidator classe to Check all validations of Search words.
  ...
  public void numberOfPages(String urlName,String searchValue)
  {
    ...
    // Calling NumberOfPagesValidator classe to Check all validations of number of pages to search.
  		...
  		if(checkValidator){
		    ...
		    //Calling search method of searchTextObject class to start crawler process .
		    URLCrawler urlCrawlerObj = searchTextObject.search(urlName,searchValue,numberOfPage);
